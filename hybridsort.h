...
#pragma omp taskwait
   ...
   namespace hybrid_merge {
      ...
      // changed to distribute buffer between threads
      template <class RandomAccessIterator, class SortedTypePointer, class Comparator>
...
#pragma omp taskwait                    
   ...
   // base recursion for out place mergesort
   ...
   // called when buffer and begin are not swapped
   template <class RandomAccessIterator, class SortedTypePointer, class Comparator>
   ...
   // distributes the sorting into tasks
   template <class RandomAccessIterator, class SortedTypePointer, class Comparator>
...
#pragma omp master
   ...
   // the task has to be an extra function to preextract the internal buffer
   template <class RandomAccessIterator, class Comparator>
...
#pragma omp master
   ...
   // executed as a task, extracts internal buffer then runs the actual sort
   template <class RandomAccessIterator, class SortedTypePointer, class Comparator>
   ...
   // divides into tasks and distributes buffer
   template <class RandomAccessIterator, class SortedTypePointer, class Comparator>
